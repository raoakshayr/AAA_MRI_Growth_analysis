...
for patient =7:7 
    ...
    for idcount=6:length(id_s)
        ...
        filename = ['C:\Users\akshayrao\Documents\Rao Summer 17\AAA\Hamid_to_Akshay\P01to14_axialdia\',a];
        delimiter = ' ';
        ...
        %% Centerline
        filename = ['C:\Users\akshayrao\Documents\Rao Summer 17\AAA\Hamid_to_Akshay\P01to14_axialdia\',b];
        delimiter = ' ';
