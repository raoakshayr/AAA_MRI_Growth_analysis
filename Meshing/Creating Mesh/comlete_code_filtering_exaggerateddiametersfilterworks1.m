...
for idcount=2:2%length(id_cl)
    ...
    clearvars -except cl_ind globmaxdia globmindia globmax_ecc globmax_per per_maxdia ecc_maxdia tort_disp_maxdia maxtort_disp tort_cl d idcount id_s id_cl list Pint para pat_id;
    save([pat_id(1:4),'.mat']);
    idcount=idcount+1;
end
